...
namespace UnitTest
{
    public class StartScriptDAPTransferDAPDigitalPhotographsTest
    {
        WebDriver webDriver;
    ...
    public class StartScriptDAPTransferDAPDigitalPhotographs
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Start Script Button - DAP Digital Photographs- DAP Transfer - Test Documentation - 05-04-2022.html";
        ...
        StartScriptDAPTransferDAPDigitalPhotographsTest script = new StartScriptDAPTransferDAPDigitalPhotographsTest();
        ...
        public void test_StartScriptDAPTransferDigitalReferee()
        {
            ...
            ExtentStart();
            var test = extent.CreateTest("HMPO - Start Script - DAP Digital Photographs - DAP Transfer Changes Test").Info("Test Started");
            ...
            selectElement.SelectByText("DAP Digital Photographs");
            ...
            driver.FindElement(By.Id("ffb9474c-12e3-4e79-aeb1-4afbf9c01df9")).SendKeys("5");
            ...
            driver.FindElement(By.Id("2f04e272-9c8e-474e-b8ed-ec815dcebf2c")).SendKeys("07888888888");
