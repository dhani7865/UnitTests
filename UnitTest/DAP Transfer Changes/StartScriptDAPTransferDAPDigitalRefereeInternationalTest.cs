...
namespace UnitTest
{
    public class StartScriptDAPTransferDAPDigitalRefereeInternationalTest
    {
        WebDriver webDriver;
    ...
    public class StartScriptDAPTransferDAPDigitalRefereeInternational
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Start Script Button - Digital Referee International - DAP Transfer - Test Documentation - 05-04-2022.html";
        ...
        StartScriptDAPTransferDAPDigitalRefereeInternationalTest script = new StartScriptDAPTransferDAPDigitalRefereeInternationalTest();
        ...
        [Test]
        public void test_StartScriptDAPTransferDigitalReferee()
        {

            ExtentStart();
            var test = extent.CreateTest("HMPO - Start Script - Digital Referee International - DAP Transfer Changes Test").Info("Test Started");
            ...
            // Test 9
            // Clicking the continue button
            // driver.FindElement(By.Id("pageCapture")).Click();
            ...
            selectElement.SelectByText("DAP Digital Referee – International");
            ...
            driver.FindElement(By.Id("ffb9474c-12e3-4e79-aeb1-4afbf9c01df9")).SendKeys("2");
            ...
            driver.FindElement(By.Id("2f04e272-9c8e-474e-b8ed-ec815dcebf2c")).SendKeys("07999999998");
