...
namespace UnitTest
{
    public class StartScriptAddNewPrioritizationTest
    {
        WebDriver webDriver;


        public void Init_Prioritization()
        {
    ...
    public class StartScriptAddNewPrioritization
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Start Script Button - Add New Prioritization - Test Documentation - 05-04-2022.html";
        ...
        StartScriptAddNewPrioritizationTest script = new StartScriptAddNewPrioritizationTest();
        ...
        {
            script.Init_Prioritization();
        }

        [Test]
        public void test_Prioritization()
        {

            ExtentStart();
            var test = extent.CreateTest("HMPO - Start Script - Task Classification Add New Prioritization Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("CallReasonCheckBoxes_7__isSelected")).Click();
            ...
            driver.FindElement(By.Id("TelephoneNumberViewModel_TelephoneNumber")).SendKeys("07888888877");
            ...
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "ntering the notes");
            test.Log(Status.Pass, "Test 21 Passed");
            extent.Flush();

            // Test 22
            // Entering the Application Number
            driver.FindElement(By.Id("ffb9474c-12e3-4e79-aeb1-4afbf9c01df9")).SendKeys("12");
            ...
            // Test 23
            // Selecting the Task Classification - Upgrades
            dropdown = driver.FindElement(By.Id("TaskClassificationId"));

            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Upgrades");

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting the Task Classification - Upgrades");
            test.Log(Status.Pass, "Test 23 Passed");
            extent.Flush();

            // Test 24
            // Clicking the submit task button
            driver.FindElement(By.Id("SubmitCreateUpdateTask")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking the submit task button");
