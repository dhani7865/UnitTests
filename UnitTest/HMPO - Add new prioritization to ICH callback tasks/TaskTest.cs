...
namespace UnitTest
{
    public class TaskAddNewPrioritizationTest
    {
        WebDriver webDriver;


        public void Init_TaskPrioritization()
        {
    ...
    public class TaskAddNewPrioritization
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Task Button - Add New Prioritization - Test Documentation - 05-04-2022.html";
        ...
        TaskAddNewPrioritizationTest script = new TaskAddNewPrioritizationTest();
        ...
        {
            script.Init_TaskPrioritization();
        }
        ...
        [Test]
        public void test_TaskPrioritization()
        {

            ExtentStart();
            var test = extent.CreateTest("HMPO - Task - Task Classification Add New Prioritization Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("ContactFirstName")).SendKeys("Testing");
            ...
            driver.FindElement(By.Id("ContactLastName")).SendKeys("Last");
