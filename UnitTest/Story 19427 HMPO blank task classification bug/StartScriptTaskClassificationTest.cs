...
namespace UnitTest
{
    ...
    public class StartScriptTaskClassificationTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Start Script Button - Test Documentation - 05-04-2022.html";
            // string reportPath = projectPath + "TestReport\\Task Button - Test Documentation - 30-03-2022.html";
            // string reportPath = projectPath + "TestReport\\Start Script Button - Duplicate Task - Test Documentation - 31-03-2022.html";
        ...
        StartScriptTest script = new StartScriptTest();
        ...
        public void test_TaskClassification()
        {
            ...
            ExtentStart();
            var test = extent.CreateTest("HMPO - Start Script - Task Classification Test").Info("Test Started");
