...
namespace UnitTest
{
    public class CallForwardReservesEmailOpenRoleTest
    {
        WebDriver webDriver;


        public void Init_CallForwardReservesEmailOpenRoleTest()
        {
    ...
    public class CallForwardReservesEmailOpenRole
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF CallForward - Reserves Email Open Role - Test Documentation - 19-05-2022.html";
        ...
        CallForwardReservesEmailOpenRoleTest script = new CallForwardReservesEmailOpenRoleTest();
        ...
        {
            script.Init_CallForwardReservesEmailOpenRoleTest();
        }
        ...
        [Test]
        public void test_CallForwardReservesEmailOpenRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - CallForward - Reserves Email Open Role Test").Info("Test Started");
