...
namespace UnitTest
{
    public class CallForwardReservesEmailClosedRoleTest
    {
        WebDriver webDriver;


        public void Init_CallForwardReservesEmailClosedRoleTest()
        {
    ...
    public class CallForwardReservesEmailClosedRole
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Call Forward - Reserves Email Closed Role - Test Documentation - 19-05-2022.html";
        ...
        CallForwardReservesEmailClosedRoleTest script = new CallForwardReservesEmailClosedRoleTest();
        ...
        {
            script.Init_CallForwardReservesEmailClosedRoleTest();
        }
        ...
        [Test]
        public void test_CallForwardReservesEmailClosedRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - CallForward - Reserves Email Closed Role Test").Info("Test Started");
