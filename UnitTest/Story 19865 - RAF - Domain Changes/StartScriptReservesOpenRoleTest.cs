...
namespace UnitTest
{
    public class StartScriptReservesOpenRoleTest
    {
        WebDriver webDriver;


        public void Init_StartScriptReservesOpenRoleTest()
        {
    ...
    public class StartScriptReservesOpenRole
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Start Script - Reserves Open Role- Test Documentation - 19-05-2022.html";
        ...
        StartScriptReservesOpenRoleTest script = new StartScriptReservesOpenRoleTest();
        ...
        {
            script.Init_StartScriptReservesOpenRoleTest();
        }
        ...
        [Test]
        public void test_StartScriptReservesOpenRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Reserves Open Role Test").Info("Test Started");
