...
namespace UnitTest
{
    public class StartScriptRegularsOpenRoleTest
    {
        ...
        public void Init_StartScriptRegularsOpenRoleTest()
        {
    ...
    public class StartScriptRegularsOpenRole
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Start Script - Regulars Open Role - Test Documentation - 19-05-2022.html";
        ...
        StartScriptRegularsOpenRoleTest script = new StartScriptRegularsOpenRoleTest();
        ...
        {
            script.Init_StartScriptRegularsOpenRoleTest();
        }
        ...
        [Test]
        public void test_StartScriptRegularsOpenRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Regulars Open Role Test").Info("Test Started");
