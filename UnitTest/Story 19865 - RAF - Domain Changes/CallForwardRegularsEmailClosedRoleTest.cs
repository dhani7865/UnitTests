...
namespace UnitTest
{
    public class CallForwardRegularsEmailClosedRoleTest
    {
        WebDriver webDriver;


        public void Init_CallForwardRegularsEmailClosedRoleTest()
        {
    ...
    public class CallForwardRegularsEmailClosedRole
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Call Forward - Regulars Email Closed Role - Test Documentation - 19-05-2022.html";
        ...
        CallForwardRegularsEmailClosedRoleTest script = new CallForwardRegularsEmailClosedRoleTest();
        ...
        {
            script.Init_CallForwardRegularsEmailClosedRoleTest();
        }
        ...
        [Test]
        public void test_CallForwardRegularsEmailClosedRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Call Forward - Regulars Email Closed Role Test").Info("Test Started");
