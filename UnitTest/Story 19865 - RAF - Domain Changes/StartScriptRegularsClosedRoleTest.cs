...
namespace UnitTest
{
    public class StartScriptRegularsClosedRoleTest
    {
        WebDriver webDriver;


        public void Init_StartScriptRegularsClosedRoleTest()
        {
    ...
    public class StartScriptRegularsClosedRole
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Start Script - Regulars Closed Role - Test Documentation - 19-05-2022.html";
        ...
        StartScriptRegularsClosedRoleTest script = new StartScriptRegularsClosedRoleTest();
        ...
        {
            script.Init_StartScriptRegularsClosedRoleTest();
        }
        ...
        [Test]
        public void test_StartScriptRegularsClosedRoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Start Script - Regulars Closed Role Test").Info("Test Started");
