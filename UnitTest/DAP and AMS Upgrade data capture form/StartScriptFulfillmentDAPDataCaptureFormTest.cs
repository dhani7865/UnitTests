...
namespace UnitTest
{
    public class StartScriptFulfillmentDAPDataCaptureForm
    {
        WebDriver webDriver;
    ...
    public class StartScriptFulfillmentDAPDataCapture
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Start Script Button - Fulfillment - DAP Data Capture Form - Test Documentation - 11-04-2022.html";
        ...
        StartScriptFulfillmentDAPDataCaptureForm script = new StartScriptFulfillmentDAPDataCaptureForm();
        ...
        public void test_StartScriptDAPTransferDAPCustomerErrorTest()
        {
            ...
            ExtentStart();
            var test = extent.CreateTest("HMPO - Start Script - Fulfillment - DAP Data Capture Form Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("TelephoneNumberViewModel_TelephoneNumber")).SendKeys("0777777777");
            ...
            // Test 17
            // Selecting the amount for the DAP Upgrade
            driver.FindElement(By.Name("FulfilmentItems[4].AmountRequested")).Clear();
            driver.FindElement(By.Name("FulfilmentItems[4].AmountRequested")).SendKeys("1");
            driver.FindElement(By.Name("FulfilmentItems[4].AmountRequested")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting the amount for the DAP Upgrade");
            ...
            dropdown.FindElement(By.XPath("//option[. = 'Child First']")).Click();
            ...
            // Test 21
            // Selecting NO for Is passport needed within 2 weeks?
            dropdown = driver.FindElement(By.Id("157e3c3b-8a47-4e3a-b544-1d3bb692143f"));
            ...
            System.Threading.Thread.Sleep(3000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting NO for Is passport needed within 2 weeks?");
            ...
            // Test 23
            // Selecting NO for Application date more than 10 weeks?
            dropdown = driver.FindElement(By.Id("2fa0e686-de3e-4b64-8ba6-5003c65fd0b6"));
            ...
            System.Threading.Thread.Sleep(3000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting NO for Application date more than 10 weeks?");
            test.Log(Status.Pass, "Test 23 Passed");
            extent.Flush();

            // Test 24
            // Selecting YES for Docs received / scanned / validated?
            dropdown = driver.FindElement(By.Id("1493fd40-0c97-4d09-bd9b-b89addfc7c95"));
            ...
            System.Threading.Thread.Sleep(3000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting YES for Docs received / scanned / validated?");
            ...
            driver.FindElement(By.Id("00fee1c0-a968-4f3f-9c38-34a2d1f4a41d")).SendKeys("First Last");
            ...
            driver.FindElement(By.Id("0b15743f-342a-4751-a2c8-27bc8232798f")).SendKeys("0777777777");
            ...
            driver.FindElement(By.Id("0dd39804-b4f1-4ddd-96cf-3921307355ba")).SendKeys("3");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Website Issues");
