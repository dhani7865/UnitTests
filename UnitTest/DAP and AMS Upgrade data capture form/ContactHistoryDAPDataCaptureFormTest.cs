...
namespace UnitTest
{
    public class ContactHistoryDAPDataCaptureFormTest
    {
        WebDriver webDriver;
    ...
    public class ContactHistoryDAPDataCaptureForm
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Start Script Button - Contact History DAP Data Capture Form - Test Documentation - 11-04-2022.html";
        ...
        ContactHistoryDAPDataCaptureFormTest script = new ContactHistoryDAPDataCaptureFormTest();
        ...
        [Test]
        public void test_ContactHistoryDAPDataCaptureFormTest()
        {

            ExtentStart();
            var test = extent.CreateTest("HMPO - Contact History - DAP Data Capture Form Test").Info("Test Started");
            ...
            // Test 7
            // Selecting a contact
            driver.FindElement(By.Id("contactlink-177322")).Click();
