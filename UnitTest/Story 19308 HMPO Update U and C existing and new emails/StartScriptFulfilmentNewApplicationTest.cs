...
namespace UnitTest
{
    public class StartScriptFulfilmentNewApplicationTest
    {
        WebDriver webDriver;


        public void Init_StartScriptFulfilmentNewApplicationTest()
        {
    ...
    public class StartScriptFulfilmentNewApplication
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\HMPO - Start Script Fulfilment New Application Test - Test Documentation - 27-04-2022.html";
        ...
        StartScriptFulfilmentNewApplicationTest script = new StartScriptFulfilmentNewApplicationTest();
        ...
        {
            script.Init_StartScriptFulfilmentNewApplicationTest();
        }
        ...
        [Test]
        public void test_StartScriptFulfilmentNewApplicationTest()
        {

            ExtentStart();
            var test = extent.CreateTest("HMPO - Start Script - Fulfilment New Application Test").Info("Test Started");
            ...
            driver.FindElement(By.Id("CallReasonCheckBoxes_15__isSelected")).Click();
            ...
            // Scrolling back into view and finding the element for the button to select
            ScrollintoView(driver, By.Id("979cdf83-c352-40e5-a710-ff3720653db5"));


            // Test 21
            // Entering the Callers DOB
            driver.FindElement(By.Id("42b5dc60-cf27-482d-af80-365529803392")).Click();
            driver.FindElement(By.Id("42b5dc60-cf27-482d-af80-365529803392")).SendKeys("02/02/1993");
            ...
            selectElement.SelectByText("Durham");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Replacement");
            ...
            driver.FindElement(By.Id("2ae0926c-4201-4573-aad2-984dbc42f7b0")).SendKeys("Desk");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Government");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("New Application");
            ...
            driver.FindElement(By.Id("DateOfBirth")).SendKeys("02/02/1993");
            ...
            driver.FindElement(By.Id("ApplicantNumber")).SendKeys("2");

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Entering the Reference Number");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Brexit");
            ...
            selectElement = new SelectElement(dropdown);
            selectElement.SelectByText("Blue UK Passport Queries");
