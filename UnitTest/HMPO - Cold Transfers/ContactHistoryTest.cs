...
namespace UnitTest
{
    ...
    public class ContactHistory
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Contact History Button Cold Transfer - Test Documentation - 05-04-2022.html";
        ...
        public void test_ColdTransfer()
        {
            ...
            var test = extent.CreateTest("HMPO - Contact History Cold Transfer Test").Info("Test Started");
            ...
            // Test 2
            // Clicking on the Contact History Button and finding a warm transfer
            IWebElement element = driver.FindElement(By.CssSelector("li:nth-child(4) img"));
            element.Click();
            ...
            // Test 3
            // Enterring First for the FirstName
            ...
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Enterring First for the FirstName");
            ...
            // Test 5
            // Selecting a Contact from the Contact History Search Results page
            driver.FindElement(By.Id("contactlink-4002")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(2000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting a Contact from the Contact History Search Results page");
            test.Log(Status.Pass, "Test 5 Passed");
            extent.Flush();

            // Test 6
            // Clicking the transfers button
