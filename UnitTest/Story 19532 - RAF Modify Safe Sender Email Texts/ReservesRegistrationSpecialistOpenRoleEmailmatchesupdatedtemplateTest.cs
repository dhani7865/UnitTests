...
namespace UnitTest
{
    public class ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplateTest
    {
        WebDriver webDriver;


        public void Init_ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplateTest()
        {
    ...
    public class ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplate
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Role Admin - Reserves Registration Specialist Open Role Email matches updated template Test - Test Documentation - 27-04-2022.html";
        ...
        ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplateTest script = new ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplateTest();
        ...
        {
            script.Init_ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplateTest();
        }
        ...
        [Test]
        public void test_ReservesRegistrationSpecialistOpenRoleEmailmatchesupdatedtemplateTest()
        {

            ExtentStart();
            var test = extent.CreateTest("RAF - Role Admin - Reserves Registration Specialist Open Role Email matches updated template Test").Info("Test Started");
