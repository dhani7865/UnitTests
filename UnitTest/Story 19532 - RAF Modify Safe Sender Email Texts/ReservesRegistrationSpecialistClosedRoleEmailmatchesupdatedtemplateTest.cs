...
namespace UnitTest
{
    public class ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplateTest
    {
        WebDriver webDriver;


        public void Init_ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplateTest()
        {
    ...
    public class ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplate
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\RAF Role Admin - Reserves Registration Specialist Closed Role Email matches updated template Test - Test Documentation - 27-04-2022.html";
        ...
        ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplateTest script = new ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplateTest();
        ...
        {
            script.Init_ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplateTest();
        }
        ...
        public void test_ReservesRegistrationSpecialistClosedRoleEmailmatchesupdatedtemplateTest()
        {
            ...
            ExtentStart();
            var test = extent.CreateTest("RAF - Role Admin - Reserves Registration Specialist Closed Role Email matches updated template Test").Info("Test Started");
